...
`depth=2`. It compares domain index hubs only with TF-IDF weighted scores, boosts
explicit cross-domain links found in those hubs, and its text output lists candidate
domain pairs, scores,
